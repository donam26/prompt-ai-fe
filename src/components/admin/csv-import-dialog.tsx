    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Chọn file CSV để import danh sách người dùng. File CSV cần có các
            cột: FirstName, LastName, Email, JoinedDate.
          </DialogDescription>
        </DialogHeader>
          ...
          >
            ...
            {selectedFile ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-500 text-xs">Chỉ hỗ trợ file .csv</p>
              </div>
            )}
          </div>
